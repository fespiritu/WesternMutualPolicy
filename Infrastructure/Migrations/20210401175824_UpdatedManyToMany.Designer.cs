...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20210401175824_UpdatedManyToMany")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoveragePolicy", b =>
                {
                    ...
                    b.Property<int>("PolicysId")
                        .HasColumnType("int");

                    b.HasKey("CoveragesId", "PolicysId");

                    b.HasIndex("PolicysId");
            ...
            modelBuilder.Entity("CoveragePolicy", b =>
                {
                    b.HasOne("Core.Entities.Coverage", null)
                        .WithMany()
                        .HasForeignKey("CoveragesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Entities.Policy", null)
                        .WithMany()
                        .HasForeignKey("PolicysId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
